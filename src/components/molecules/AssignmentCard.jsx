...
const AssignmentCard = ({ assignment, course, onToggleComplete, onEdit, onDelete }) => {
  ...
  const isDue = isPast(assignment.dueDate) && !assignment.completed;
  ...
  return (
    <Card className={cn(
      ...
      isDue && !assignment.completed && "border-l-4 border-red-500"
    )}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mt-3">
            <div className="flex items-center text-sm text-gray-500">
              ...
              <span className={cn(
                isDue && !assignment.completed && "text-red-600 font-medium"
              )}>
